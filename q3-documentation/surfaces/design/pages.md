...
- **Page header** — contains the `<h1>` (page title), breadcrumb navigation, and primary CTA if applicable.
...
- **Persistent filter bar** — anchored below the page header.
...
| 4 | Primary CTA and secondary actions (right-aligned) |
